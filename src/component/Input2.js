...
function Input2() {
  ...
  function handleClick() {
    ...
    // fetch('http://94.101.187.211:3000/update_schedule', {  // Enter your IP address here
    // headers: {
    ...
    axios(
      {
          url: 'http://94.101.187.211:3000/update_schedule',
          method: 'POST',
          data: jsonData,
    ...
    // axios('http://94.101.187.211:3000/status', {
    //   method: 'GET',
    //   headers: {
    //     'Access-Control-Allow-Origin': '*',
    //     'Accept': 'application/json',
